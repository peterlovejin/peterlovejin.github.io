...
full=NULL
  ...
  my=c("2390","6180","1570","2727","3679","6207","2841","5410","2929" ,"1570","8112","2363","6226","8936","8941","00715L","6246","1340","2888","1540","6205","2883","1471","5521","2867","2542")
...
for (x in j) {
print(aa2 %>% filter(stake==x) %>% ggplot(aes(as.character(date),total))+geom_bar(aes(fill=ifelse(total>0,"blue","red")),stat="identity",position="dodge")+geom_hline(yintercept=0)+labs(title=x,x="",y="") +theme(axis.text.x = element_text(angle=90,size = 6),legend.position = "none")+facet_wrap(name~.,ncol=7))
}
